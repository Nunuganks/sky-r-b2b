...
interface CompactImageGalleryFieldProps {
  value?: any[];
  onChange?: (value: any[]) => void;
}

const CompactImageGalleryField: React.FC<CompactImageGalleryFieldProps> = ({ value = [], onChange }) => {
...
export default CompactImageGalleryField; 